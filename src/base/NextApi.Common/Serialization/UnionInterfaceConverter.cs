...
{
    /// <summary>
    /// Converts interfaces with Union correctly (in situation when interface has inheritors)
    /// </summary>
    public class UnionInterfaceConverter : JsonConverter
    {
        // each thread has own cache!
        [ThreadStatic] private static List<UnionTypeItem> s_unionTypes;
        ...
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
        {
            ...
            var typeKey = s_unionTypes.First(t => t.SubType == value.GetType()).SubTypeKey;
            ...
            JsonSerializer serializer)
        {
            ...
            var correctType = s_unionTypes.FirstOrDefault(t => t.BaseType == objectType && t.SubTypeKey == typeKey)
                .SubType;
        ...
        public override bool CanConvert(Type objectType)
        {
            ...
            if (s_unionTypes != null && (s_unionTypes.Any(t => t.BaseType == objectType) ||
                                        s_unionTypes.Any(t => t.SubType == objectType)))
                return true;
