...
using Abitech.NextApi.Client.Autofac;
using Abitech.NextApi.Client.MicrosoftDI;
using Autofac;
using Microsoft.Extensions.DependencyInjection;
using Xunit;
using Xunit.Abstractions;

namespace Abitech.NextApi.Client.Tests
{
    ...
    static class TestExtensions
    {
        ...
        public static void AddTestClientServices<TTokenProvider>(this IServiceCollection services, string url)
            where TTokenProvider : class, INextApiAccessTokenProvider
        {
            allServices.RegisterInMicrosoftDI<TTokenProvider, ITestClient>(services,
